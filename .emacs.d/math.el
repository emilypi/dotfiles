;;; math.el --- Math keybindings
;;; Commentary: better support for greek and mathematical symbols
...
;; Math Aliases
(global-set-key (kbd "M-g C-m f") "∀")
(global-set-key (kbd "M-g C-m e") "∃")
(global-set-key (kbd "M-g C-m F") "⊥")
(global-set-key (kbd "M-g C-m V") "⊤")
;;; math.el ends here
